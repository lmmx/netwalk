...
from .util import ptime # for tiling.tileset import!
...
def read_game_image():
    ...
    # game_img = imread(data_dir / 'lgo_netwalk_example_game_state.png')
    # game_img = imread(data_dir + 'lgo_netwalk_example_game_state.png')
    game_img = imread(data_dir + 'lgo_netwalk_example_game_state_expert.png')
    return game_img
